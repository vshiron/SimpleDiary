 ...
 *  背景色
 */ 
#define CoreLockViewBgColor rgba(92,153,0,1)
 ...
 *  外环线条颜色：选中
 */
#define CoreLockCircleLineSelectedColor rgba(249,254,249,1)


/*
 *  实心圆
 */
#define CoreLockCircleLineSelectedCircleColor rgba(192,245,110,1)


/*
 *  实心圆
 */
#define CoreLockLockLineColor rgba(233,251,0,1)
